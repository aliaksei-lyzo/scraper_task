...
class TestArticleSummarizer:
    ...
    def test_summarize_concise(self, sample_article, mock_openai_env):
        ...
        with patch('src.summarizer.load_summarize_chain') as mock_chain:
            ...
            mock_chain_instance.run.return_value = "Classification: Technology - This is a concise test summary."
            ...
            assert "Classification: Technology" in result.summary
    ...
    def test_summarize_detailed(self, sample_article, mock_openai_env):
        ...
        with patch('src.summarizer.load_summarize_chain') as mock_chain:
            # Mock the summarize chain
            mock_chain_instance = MagicMock()
            mock_chain_instance.run.return_value = "Classification: Science - This is a detailed test summary with more information."
            mock_chain.return_value = mock_chain_instance
            ...
            # Verify the result
            assert isinstance(result, ArticleSummary)
            assert "Classification: Science" in result.summary
